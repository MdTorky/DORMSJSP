...
public class InspectController {
	...
	public String inspect(@RequestParam("bed_frame") int bed_frame, @RequestParam("table") int table,
			@RequestParam("chair") int chair, @RequestParam("wardrobe") int wardrobe, @RequestParam("door") int door,
			@RequestParam("windows") int windows, @RequestParam("checkOutApplicationId") int checkOutApplicationId,
