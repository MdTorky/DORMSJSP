...
::-webkit-calendar-picker-indicator {
	filter: invert(74%) sepia(93%) saturate(773%) hue-rotate(357deg)
		...
		<thead class="table-header">
          ...
          <th class="header__item">
            <a id="fees" class="filter__link filter__link" href="#">Fees</a>
				...
				<th class="header__item"><a id="fullName" class="filter__link"
					href="#">FullName</a></th>
				<th class="header__item"><a id="phoneNo"
					class="filter__link filter__link" href="#">Phone No</a></th>
				<th class="header__item"><a id="roomNo"
					class="filter__link filter__link" href="#">Room Number</a></th>
				<th class="header__item"><a class="filter__link filter__link"
					href="#">Action</a></th>
			</tr>
		</thead>
			...
			<c:forEach items="${userParcelList}" var="upl" varStatus="loop">
				...
				<tr class="table-row">
					...
					<c:forEach items="${rooms}" var="room">
						<c:if test="${upl.userId == room.userId}">
						...
						<div class="containerParcel" id="div${upl.userId}">
							<section class="checkout-form">
								...
								<form class="addForm" method="post" action="addParcelInfo">
									...
									<div class="additems">
										<label for="inp" class="inp"> <input type="date"
											id="inp1" name="arrivalDate" placeholder="&nbsp;" required />
											<span class="label" style="color: gold">Add Arrival
												Date</span> <span class="focus-bg"></span>
										</label> <label for="inp" class="inp"> <input type="number"
											id="inp2" name="holdingFees" placeholder="&nbsp;" required />
											<span class="label">Add Fees</span> <span class="focus-bg"></span>
										</label>
									</div>
